<?php
/* ---------------------------------------------------------------------
   db_connect.php  ·  single MySQL connection for every Activity-08 page
   ---------------------------------------------------------------------
   Uses the object-oriented mysqli API and stops the script if the
   database is unreachable, so a missing MySQL service fails loudly
   instead of producing half-rendered pages.
   --------------------------------------------------------------------- */
